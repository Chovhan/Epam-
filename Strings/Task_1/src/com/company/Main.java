...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        addToHashMap(arrayWithWords, hashMap);
    ...
    public static HashMap addToHashMap(ArrayList arrayWithWords, HashMap hashMap) {
        String names;
        for (int i=0; i<arrayWithWords.size();i++) {
            names = arrayWithWords.get(i).toString();
            if (hashMap.containsKey(names)) {
                hashMap.put(names, Collections.frequency(arrayWithWords, names));
            }else {
                hashMap.put(names, Collections.frequency(arrayWithWords, names));
            }
        }
